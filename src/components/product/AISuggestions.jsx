...
export default function AISuggestions({ onProductClick, onClose, className }) {
  ...
  const getConfidenceColor = (c) => (c >= 0.8 ? "text-green-600" : c >= 0.6 ? "text-yellow-600" : "text-gray-600")
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-xl font-bold flex items-center gap-2">
              ...
              {loading && <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-purple-600" />}
            </h2>
            ...
            {suggestions.map((p, i) => (
              ...
              >
                ...
                <div className="absolute top-2 left-2 flex gap-2 z-10">
                  <span className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
                    🤖 AI Pick
                  </span>
                  <span className="bg-white/90 backdrop-blur text-purple-600 text-xs px-2 py-1 rounded whitespace-nowrap">
                    #{i + 1}
                  </span>
                </div>
                {/* Dismiss */}
                ...
                <div className="p-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-purple-600 hover:text-purple-700 text-sm font-semibold flex items-center gap-1 group whitespace-nowrap"
                    >
                      Chi tiết
                      <svg
        ...
        {!loading && suggestions.length > 0 && (
          <div className="mt-4 flex justify-center">
            <button
              ...
              className="px-4 py-2 bg-white text-purple-600 rounded-lg hover:bg-purple-50 transition-colors flex items-center gap-2 whitespace-nowrap"
            >
              Gợi ý khác
            </button>
          </div>
